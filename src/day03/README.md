...
In the above example, the priority of the item type that appears in both compartments of each rucksack is 16 (_p_), 38 (_L_), 42 (_P_), 22 (_v_), 20 (_t_), and 19 (_s_); the sum of these is **157**.
...
Priorities for these items must still be found to organize the sticker attachment efforts: here, they are 18 (_r_) for the first group and 52 (_Z_) for the second group. The sum of these is **70**.
