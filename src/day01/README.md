...
In the example above, the top three Elves are the fourth Elf (with _24000_ Calories), then the third Elf (with _11000_ Calories), then the fifth Elf (with _10000_ Calories). The sum of the Calories carried by these three elves is **45000**.
